export const calculateRemoteRtpQuality = (producerScores) => {
    ...
    return producerScores.reduce((currScore, prevScore) => (currScore > prevScore ? currScore : prevScore));
};
...
export const calculateLocalRtpQuality = (consumerScores) => {
    ...
    return consumerScores.reduce((currScore, prevScore) => (currScore.score > prevScore.score ? currScore : prevScore))
        .score;
};
